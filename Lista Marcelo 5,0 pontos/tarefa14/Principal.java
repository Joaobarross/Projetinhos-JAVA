...
public class Principal {
	...
	public static void main(String[] args) throws Exception {
        ...
        acoes = Integer.parseInt(JOptionPane.showInputDialog(null, 
        		...
        		"\n" + "2- Fazer um upgrade no computador " + 
        		"\n" + "3- Remover um computador" + 
        		"\n" + "4- Imprimir computador" + 
        		"\n" + "0- Sair"));
        while(acoes!=0) {
        	switch (acoes) {
        		case 1:{
        			modelo = JOptionPane.showInputDialog(null, "Digite o modelo do computador: ");
                    memoria = JOptionPane.showInputDialog(null, "Digite a memoria do computador: ");
                    armazenamento = JOptionPane.showInputDialog(null, "Informe o armazenamento interno do computador: ");
        		...
        		case 2:{
                    memoria = JOptionPane.showInputDialog(null, "Informe a memoria(RAM) do upgrade: ");
                    armazenamento = JOptionPane.showInputDialog(null, "Informe o armazenamento interno do upgrade: ");
